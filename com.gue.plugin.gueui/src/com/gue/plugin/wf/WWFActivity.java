 ...
 * @author hengsin
 * @author GueShindu: update ke versi terbaru idempiere (9)
 * Custom beberapa bagian sesuai kebutuhan user
 * 25 Sep 2021
 */
public class WWFActivity extends ADForm implements EventListener<Event>
{
	...
	//Modified by shindu
	//Add overflow: scroll
	private final static String HISTORY_DIV_START_TAG = "<div style=' overflow: scroll; height: 100px; border: 1px solid #7F9DB9;'>";
	//End modif
	public WWFActivity()
	{
		super();
	...
	public void onEvent(Event event) throws Exception
	{
        ...
        else if (Events.ON_SELECT.equals(eventName) && comp == listbox)
        {
        	...
        	//log.log(Level.INFO, eventName + ".Index: " + m_index);
        	if (m_index >= 0)
    			display(m_index);
        }
        else
		...
		if (MWFNode.ACTION_UserChoice.equals(node.getAction()))
		{
			...
			if (m_column != null && m_column.get_ID() != 0)
			{
				...
				if (dt == DisplayType.YesNo)
				{
					...
					/* Modified by shindu sep 25 2021
					Original: 
					...
					*/
					//Modified: ganti kata menjadi Approve/Reject 
					fAnswerList.appendItem("Approve", 'Y');
					fAnswerList.appendItem("Reject", 'N');
					//End shindu
